package newjohn.com.pigpen.serv;
...
import newjohn.com.pigpen.activity.AlertActivity;
   ...
   public void connect(){
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                webSocketClient = new WebSocketClient(URI.create("ws://120.78.209.11:8080/FeedWebProject/websocket"), new Draft_6455(), headers, 5*1000) {
