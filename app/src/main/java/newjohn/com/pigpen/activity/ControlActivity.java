...
import newjohn.com.pigpen.ui.SelfDialog;
import okhttp3.Call;
...
//                        Toast.makeText(ControlActivity.this,selfDialog.getValueMax()+selfDialog.getValueMin(),Toast.LENGTH_LONG).show();
                        try {
                            ...
                            editor.commit();
                            settingAlertValue(selfDialog.getValueMax(),selfDialog.getValueMin(),selfDialog.getType());
                            selfDialog.dismiss();
                        }
...
//        });
    ...
    public void settingAlertValue(String max,String min ,String type ){
        ...
        RequestBody requestBody=new FormBody.Builder()
                ...
                .add("alarmType",type)
                .build();
        Log.i(TAG, "settingAlertValue: "+max+min+type);
        final Request request=new Request.Builder()
                .url(Constant.URL+"FeedWebProject/setAlarmValu")
                .post(requestBody)
                .build();
