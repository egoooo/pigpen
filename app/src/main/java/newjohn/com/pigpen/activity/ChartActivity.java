...
import newjohn.com.pigpen.GraphBean.ContentData;
import newjohn.com.pigpen.GraphBean.GraphData;
...
import newjohn.com.pigpen.ui.CustomToast;
import okhttp3.Call;
...
//        highlimit=sharedPreferences.getFloat("max",100.2F);
    ...
    public void getdata() {
        ...
        final Request request = new Request.Builder()
                .url(Constant.URL+"FeedWebProject/getThrend")
                .post(requestBody)
                .build();
...
//                                }
//                                else {
                                    set1=new LineDataSet(values1,graphDatas.get(k).getDeviceNum()+sensorType(graphDatas.get(k).getDeviceNum()));
...
//                                else {
                                    ...
                                    set2=new LineDataSet(values2,graphDatas.get(k).getDeviceNum()+sensorType(graphDatas.get(k).getDeviceNum()));
...
//                                }
//                                else {
                                    set3=new LineDataSet(values3,graphDatas.get(k).getDeviceNum()+sensorType(graphDatas.get(k).getDeviceNum()));
